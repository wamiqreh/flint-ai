...
Usage:
    OPENAI_API_KEY=sk-... python examples/basics/human_approval.py
...
def approval_callback(node_id: str, upstream_output: str) -> bool:
    """Called when a human-approval node is reached. Return True to approve."""
    print(f"\n[LOCK] Node '{node_id}' requires approval.")
    print(f"   Approve via UI: http://localhost:5160/ui/")
